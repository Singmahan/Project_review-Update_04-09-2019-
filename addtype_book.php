...
<html lang="en">
  <head>
    ...
    <title>เพิ่มประเภทหนังสือ</title>
              ...
              <div style="padding-top:30px" class="panel-body">
                ...
                <form class="form-horizontal" action="addtype_book_db.php" method="post">
                  <div class="form-group">
                    <label class="col-sm-3 control-label">ชื่อประเภทหนังสือ</label>
                    <div class="col-sm-8">
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-8">
                      ...
                      <a href="addtype_book.php" class="btn btn-danger">ยกเลิก</a>
                    </div>
                  </div>
                </form>
              </div>
        ...
        <div class="col-md-12">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center"><?php echo date('d-m-Y',strtotime($row['datetime'])); ?></td>
