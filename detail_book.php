...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <p>แบ่งปันให้เพื่อน</p>
          <div class="fb-like" data-href="https://denproject.azurewebsites.net/detail_book.php?id=<?php echo $id; ?>" data-layout="button_count" data-action="like" data-size="large" data-show-faces="true" data-share="true"></div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          ...
          <a href="comment.php?id=<?php echo $row['id']; ?>&<?php echo $row['b_name']; ?>" class="btn btn-success">เพิ่มบทวิเคราะห์</a><br><br>
        <?php }else { ?>
          <h3>เพิ่มบทวิเคราะห์</h3>
          ...
          <div class="panel-body">
            ...
            <div class="panel panel-primary">
              <div class="panel-heading">
                <p class="panel-title"><?php echo $a['c_name']; ?></p>

              </div>
              <div class="panel-body">
                <?php echo $a['c_detail']; ?>
                <p id="c_d" align="right">เพิ่มเมื่อ <?php echo date('d-m-Y',strtotime($a['c_date'])); ?></p>
              </div>
            </div>
            </div>
            <?php
    ...
    <script>(function(d, s, id) {
      ...
      js.src = 'https://connect.facebook.net/th_TH/sdk.js#xfbml=1&version=v3.1&appId=2034637763423523&autoLogAppEvents=1';
