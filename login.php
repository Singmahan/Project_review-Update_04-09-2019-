          ...
          <form class="form-horizontal" action="login_check.php" method="POST">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label">ชื่อผู้ใช้ :</label>
                  <div class="col-sm-8">
                    <input type="text" name="username" class="form-control" value="" placeholder="Username" required autofocus autocomplete="off">
                  </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <div class="col-sm-offset-2 col-sm-8">
                <a href="register.php" class=" form-control btn btn-primary">สมัครสมาชิก</a>
              </div>
            </div>
          </form>
        </div>
