              ...
              <div class="panel panel-default">
                <div class="panel-body">
                  ...
                  <div class="form-group">
                    <div class="col-sm-3">
                      <label>หน้าปก</label>
                      <input type="file" name="b_img1" class="form-control btn btn-info" value="" >
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="col-sm-3">
                      ...
                      <input type="file" name="b_img2" class="form-control btn btn-info" value="" >
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="col-sm-3">
                      ...
                      <input type="file" name="b_img3" class="form-control btn btn-info" value="" >
                      <br>
                    </div>
                  </div>
                </div>
