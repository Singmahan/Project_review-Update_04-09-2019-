<?php
   ...
   $date = date("Y-m-d");
    ...
    if (empty($ext1)) {
        ...
        move_uploaded_file($_FILES['b_img1']['tmp_name'], $upload_path1);
    ...
    if (empty($ext2)) {
        ...
        move_uploaded_file($_FILES['b_img2']['tmp_name'], $upload_path2);
    ...
    if (empty($ext3)) {
        ...
        move_uploaded_file($_FILES['b_img3']['tmp_name'], $upload_path3);
    ...
    if($result) {
      ...
      $resmail = mysqli_query($dbcon, $sql);
        while ($a = mysqli_fetch_array($resmail)) {
           ...
           $mail->Body = "<h1 align='center'>สำนักวิทยบริการและเทคโนโลยี มหาวิทยาลัยราชภัฏสกลนคร </h1>";
           ...
           $mail->Body .= "</tr>";
           $mail->Body .= "<tr>";
           $mail->Body .= "<td align='center'>".$b_name."</td>";
           $mail->Body .= "<td align='center'><img src='https://denproject.azurewebsites.net/".$upload_path1."' alt='' width='150'></td>";
           $mail->Body .= "<td align='center'><a href='https://denproject.azurewebsites.net/detail_book.php?id=".$id_insert."'>ดูรายละเอียด</a> </td>";
           $mail->Body .= "</tr>";
           $mail->Body .= "</table>";
        //    echo $mail->Body;
